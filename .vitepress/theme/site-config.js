// ============================================================
// Gtbuy Spreadsheet Site Configuration
...
export const siteConfig = {
  ...
  // ---- Brand ----
  brand: {
    name: 'Gtbuy Spreadsheet',
    tagline: 'Fashion Finds Resource & Buying Guide',
    description: 'Independent resource for Gtbuy Spreadsheet shoppers. Product guides, category breakdowns, sizing tips, and spreadsheet access — organized in one place.',
    primaryColor: '#8B0000',
    accentColor: '#d4af37',
    logoText: 'Gtbuy Spreadsheet',
  },
  ...
  categories: [
    {
      id: 'clothes',
      name: 'Gtbuy Clothing Spreadsheet',
      icon: '',
    ...
    {
      id: 'accessories',
      name: 'Gtbuy Accessories Spreadsheet',
      icon: '',
    ...
    {
      id: 'electronics',
      name: 'Gtbuy Electronics Spreadsheet',
      icon: '',
