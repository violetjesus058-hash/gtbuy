  ...
  <main class="modern-home">
    <section class="hero-section">
      <div class="page-container hero-content">
        ...
        <h1>Gtbuy Spreadsheet <span>2026</span></h1>
        <p class="hero-copy">
          Discover organized Gtbuy finds across clothing, shoes, pants, hats, accessories and electronics,
        ...
        <div class="hero-actions">
          <div class="cta-preview-wrap cta-preview-spreadsheet">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/gtbuy-spreadsheet-preview.png" alt="Gtbuy Spreadsheet preview showing curated product categories and shopping links" title="Gtbuy Spreadsheet preview" />
          ...
          <div class="cta-preview-wrap cta-preview-shopping">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/gtbuy-shopping-preview.png" alt="Gtbuy shopping preview showing product categories and item options" title="Gtbuy shopping preview" />
    ...
    <section id="essential-guides" class="section section-muted essential-guides">
      <div class="page-container">
        <div class="section-heading section-heading-left guides-heading">
          ...
          <p>New to Gtbuy? These short guides explain how the platform works, what the spreadsheet is for and how to begin with a clearer plan.</p>
        </div>
    ...
    <section id="community-research" class="section section-research">
      <div class="page-container research-card">
        <div>
          <p class="section-kicker">Shipping and returns research</p>
          <h2>Build a clearer Gtbuy shortlist before shipping.</h2>
          <p class="research-card-copy">Review simple purchase-flow questions alongside shipping quotes, warehouse timing, return rules and dispute evidence so community reports become practical verification steps.</p>
          <a href="/blog/gtbuy-community-buying-guide/" class="research-card-link">Read the Gtbuy research guide <span aria-hidden="true">→</span></a>
        </div>
        <div class="research-card-note">
          <strong>Gtbuy community research</strong>
...
const guideCards = [
  ...
  },
  {
    ...
    title: 'What Is the Gtbuy Spreadsheet?',
