...
export default defineConfig({
  ...
  head: [
    ...
    ['script', { async: '', src: 'https://www.googletagmanager.com/gtag/js?id=G-NVB7GG74JX' }],
    ['script', {}, `
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'G-NVB7GG74JX');
    `],
  ...
  srcExclude: [
    ...
    'blog/gtbuy-article-prompt.md',
    'blog/gtbuy-internal-link-rules.md',
    'blog/gtbuy-product-reference.md',
    'blog/gtbuy-review-report.md',
    'blog/gtbuy-topic-list.md',
